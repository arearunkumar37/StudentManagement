...
import org.sms.main.service.StudentService;
...
public class StudentController {
	...
	public ResponseEntity<StudentDTO> updateStudent(@PathVariable String studentCode, @RequestBody Student students)
			throws Exception {
	...
	public ResponseEntity<String> updateAddressByType(@PathVariable String studentCode, @RequestBody Address address)
			throws Exception {
		// TODO: process PUT request
	...
	@DeleteMapping("/removeCourse/{studentCode}")
	public ResponseEntity<String> removeCourse(@PathVariable String studentCode, @RequestParam String courseName)
			throws Exception {
